...
# Session key prefix and TTLs
SESSION_PREFIX = "whatsapp:session:"
SESSION_TTL_SECONDS = 48 * 3600  # 48 hours
...
class WhatsAppRedisStore:
    ...
    def __init__(self, fallback_db=None):
        self._redis = None
        self._fallback_db = fallback_db  # For get_customer_by_phone, initialize_tables
        self._connect()
    ...
    def initialize_tables(self):
        """No-op for Redis; tables are logical keys."""
    ...
    def cleanup_expired_otps(self):
        # Redis TTL handles expiry; optional scan for OTP_* keys and delete if needed
        return 0

    def cleanup_expired_sessions(self, expiry_days: int = 30):
        # Optional: scan SESSION_PREFIX keys and delete old ones by last_activity
        return 0
